"use strict";
(self["webpackChunkECG"] = self["webpackChunkECG"] || []).push([["node_modules_react-native_normalize-colors_index_js"],{
...
}]);//# sourceMappingURL=node_modules_react-native_normalize-colors_index_js.chunk.bundle.map?platform=android