...
}]);//# sourceMappingURL=vendors-node_modules_react-native_Libraries_Components_TextInput_TextInputState_js-node_modul-0afa3e.chunk.bundle.map?platform=ios