(self["webpackChunkECG"] = self["webpackChunkECG"] || []).push([["vendors-node_modules_redux_lib_redux_js"],{
...
}]);//# sourceMappingURL=vendors-node_modules_redux_lib_redux_js.chunk.bundle.map?platform=android